...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      className="flex items-center justify-center rounded-full absolute font-semibold cursor-pointer py-3 px-6 bg-dark text-light p-8 shadow-dark"
  ...
  return (
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight">
        <motion.div
          className="flex items-center justify-center rounded-full font-semibold cursor-pointer bg-dark text-light p-8 shadow-dark"
          whileHover={{ scale: 1.05 }}
        >
          Skills
        </motion.div>
        ...
        <Skill name="Photoshop" x="-6vw" y="24vw" />
