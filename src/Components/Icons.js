...
export const Instagram = ({ className, ...rest }) => (
  ...
  >
    <path
      d="M37.5 93C22.888 93 11 81.112 11 66.5v-29C11 22.888 22.888 11 37.5 11h29C81.112 11 93 22.888 93 37.5v29C93 81.112 81.112 93 66.5 93h-29z"
      opacity="0.35"
    ></path>
    <path
      fill="#f2f2f2"
      d="M35.5 91C20.888 91 9 79.112 9 64.5v-29C9 20.888 20.888 9 35.5 9h29C79.112 9 91 20.888 91 35.5v29C91 79.112 79.112 91 64.5 91h-29z"
    ></path>
    <path
      fill="#964b96"
      d="M43.05 15.5L84.5 56.95 84.5 43.162 56.838 15.5z"
    ></path>
    <path
      fill="#883561"
      d="M72.147 17.021l10.832 10.832a20.065 20.065 0 00-10.832-10.832z"
    ></path>
    <path
      fill="#774696"
      d="M64.5 15.5h-7.662L84.5 43.162V35.5c0-2.709-.545-5.29-1.521-7.647L72.147 17.021A19.94 19.94 0 0064.5 15.5z"
    ></path>
    <path
      fill="#a659b3"
      d="M35.5 15.5c-1.897 0-3.724.281-5.463.775l53.688 53.688A19.98 19.98 0 0084.5 64.5v-7.55L43.05 15.5H35.5z"
    ></path>
    <path
      fill="#d84178"
      d="M21.346 21.371l57.283 57.283a19.966 19.966 0 005.096-8.691L30.037 16.275a19.96 19.96 0 00-8.691 5.096z"
    ></path>
    <path
      fill="#f4665c"
      d="M16.264 30.077l53.658 53.658a19.968 19.968 0 008.706-5.082L21.346 21.371a19.977 19.977 0 00-5.082 8.706z"
    ></path>
    <path
      fill="#ef8630"
      d="M15.5 35.5v7.601L56.899 84.5H64.5c1.882 0 3.696-.278 5.423-.764L16.264 30.077A19.973 19.973 0 0015.5 35.5z"
    ></path>
    <path
      fill="#f9b84f"
      d="M15.5 56.888L43.112 84.5 56.899 84.5 15.5 43.101z"
    ></path>
    <path
      fill="#ffe385"
      d="M15.5 64.5c0 2.739.553 5.349 1.55 7.726L27.774 82.95A19.932 19.932 0 0035.5 84.5h7.612L15.5 56.888V64.5z"
    ></path>
    <path
      fill="#ffe797"
      d="M27.774 82.95L17.05 72.226A20.065 20.065 0 0027.774 82.95z"
    ></path>
    <path
      fill="none"
      stroke="#40396e"
      strokeMiterlimit="10"
      strokeWidth="3"
      d="M64.5 84.5h-29c-11.046 0-20-8.954-20-20v-29c0-11.046 8.954-20 20-20h29c11.046 0 20 8.954 20 20v29c0 11.046-8.954 20-20 20z"
    ></path>
    <path
      fill="none"
      stroke="#fff"
      ...
      strokeLinejoin="round"
      strokeWidth="3"
      d="M60.838 26.517H39.162c-7.045 0-12.645 5.6-12.645 12.645v21.677c0 7.045 5.6 12.645 12.645 12.645h21.677c7.045 0 12.645-5.6 12.645-12.645V39.162c-.001-7.045-5.601-12.645-12.646-12.645z"
    ></path>
    <circle cx="62.995" cy="36" r="1.999" fill="#fff"></circle>
    <circle
      cx="50"
      cy="50"
      r="11.497"
